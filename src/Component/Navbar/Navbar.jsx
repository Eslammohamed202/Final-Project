    ...
    <nav className="py-5 bg-main-light ">
      <div className="container md:px-0   px-4 md:flex justify-between items-center relative">
            ...
            {isLogin ? (
              <>
                ...
                <li className="relative">
                  ...
                  <span className="w-[20px] h-[20px] absolute bottom-3 left-3 bg-green-700 rounded-full flex justify-center items-center text-white">
                    {data?.numOfCartItems}
                  </span>
                </li>

                {isLogin ? (
                  <span className="mx-3 font-bold text-green-600">
                    <b>Hi {isLogin.name} </b>
                  </span>
                ) : (
                  ""
        ...
        <span className="md:hidden">
          <i
            onClick={toggle}
            className={`fas fa-2x absolute top-0 right-4 cursor-pointer ${
              open ? "fa-close" : "fa-bars"
            } `}
          ></i>
        </span>
      </div>
